...
import { UserMessage } from './github/message'
...
export function ChatPanel({
  ...
  const exampleMessages = [
    ...
    },
    {
      ...
      subheading: '',
      message: 'display_folder_analysisを呼び出します。'
    },
    {
      heading: 'リポジトリ全体のコード分析結果を表示する',
      subheading: '',
      message: 'display_code_analysisを呼び出します。'
    },
    {
      heading: 'リポジトリのコード分析結果を表示する',
      subheading: '',
      message: 'display_code_analysisを呼び出します。'
    }
  ]
